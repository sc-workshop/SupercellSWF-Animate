...
namespace sc { namespace Adobe {
    ...
    extern "C" FCMPLUGIN_IMP_EXP FCM::Result PluginGetClassInfo(FCM::PIFCMCalloc falloc,
    ...
    extern "C" FCMPLUGIN_IMP_EXP FCM::Result PluginGetClassObject(FCM::PIFCMUnknown,
        ...
        Module->logger->info("Called get PluginGetClassObject clsid: {}, iid: {}",
                             clsid_name.c_str(),
                             iid_name.c_str());
#endif
    ...
    extern "C" FCMPLUGIN_IMP_EXP FCM::Result PluginRegister(FCM::PIFCMPluginDictionary pluginDict) {
