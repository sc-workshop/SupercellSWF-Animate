...
namespace sc::Adobe {
    wxBEGIN_EVENT_TABLE(PluginWindow, wxDialog) EVT_CLOSE(PluginWindow::OnClose)
        SC_EVT_CREATE_PROGRESS(wxID_ANY, PluginWindow::OnProgressCreate)
            SC_EVT_DESTROY_PROGRESS(wxID_ANY, PluginWindow::OnProgressDestroy) wxEND_EVENT_TABLE();
    ...
    StatusComponent* PluginWindow::CreateStatusBarComponent(const std::u16string& title,
