...
namespace sc
{
	namespace Adobe
	{
		...
		PluginDestroyProgressEvent::PluginDestroyProgressEvent(
			StatusComponent* component, bool* destroyed
		) : wxCommandEvent(AN_EVT_DESTROY_PROGRESS, wxID_ANY), component(component), destroyed(destroyed)
		{};
