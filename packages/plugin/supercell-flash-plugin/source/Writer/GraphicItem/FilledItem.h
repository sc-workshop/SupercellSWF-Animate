...
namespace sc::Adobe {
    ...
    public:
        FilledItemContour(const std::vector<Point>& contour) :
            m_contour(contour) {}

        const std::vector<Point>& Contour() const { return m_contour; }
    ...
    public:
        FilledItem(Animate::Publisher::SymbolContext& context,
    ...
    public:
        virtual bool IsSolidColor() const { return true; }

    public:
        virtual const wk::ColorRGBA& Color() const { return m_color; }
