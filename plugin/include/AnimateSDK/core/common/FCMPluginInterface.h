...
#include "AnimateSDK/core/IFCMCalloc.h"
#include "AnimateSDK/core/IFCMCallback.h"
#include "AnimateSDK/core/IFCMList.h"
#include "AnimateSDK/core/IFCMClassFactory.h"
#include "AnimateSDK/core/IFCMPluginDictionary.h"
#include "AnimateSDK/core/IFCMNoAggregationUnknown.h"
...
namespace FCM
{
	...
	public:
		...
		FCM::Result getClassObject(FCM::PIFCMUnknown, FCM::ConstRefFCMCLSID clsid, FCM::ConstRefFCMIID iid, FCM::PPVoid pAny)
		{
			using namespace FCM;
