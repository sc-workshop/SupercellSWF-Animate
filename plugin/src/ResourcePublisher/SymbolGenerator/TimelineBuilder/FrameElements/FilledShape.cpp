...
namespace sc {
	namespace Adobe {
		...
		FilledShapePath::FilledShapePath(Context& context, FCM::AutoPtr<IPath> path) {
		...
		FilledShapeRegion::FilledShapeRegion(Context& context, FCM::AutoPtr<IFilledRegion> region) {
			// Contour
			{
		...
		FilledShape::FilledShape(Context& context, FCM::AutoPtr<DOM::FrameElement::IShape> shape) {
